...
export default class TextStyles {
    private static instance: TextStyles;
    ...
    public static getInstance(width) {
        if (!TextStyles.instance) {
            TextStyles.instance = new TextStyles(width);
        }
        (<any>window).textStyles=TextStyles.instance;
